...
const navigation = [
  { name: 'Analytics', href: '/dashboard/manufacturer/analytics', icon: ChartBarIcon },
  { name: 'Products', href: '/dashboard/manufacturer/products', icon: CubeIcon },
  { name: 'Reports', href: '/dashboard/manufacturer/reports', icon: DocumentChartBarIcon },
];
